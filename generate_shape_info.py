...
DEFAULT_MAINIFEST = "/ceph-jb/yaozengwei/workspace/rnnt/icefall/egs/librispeech/ASR/data/fbank/cuts_train-clean-100.json.gz"  # noqa
DEFAULT_BPE_MODEL_FILE = "/ceph-jb/yaozengwei/workspace/rnnt/icefall/egs/librispeech/ASR/data/lang_bpe_500/bpe.model"  # noqa
